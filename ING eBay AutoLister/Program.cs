...
// The cross-category sweep. Mines the sold-comps database for products that carry
...
// logic; the Rising-Demand radar below reads the same sweep along a different axis.
...
// LocalArbitrageAnalyzer.Build, the identical path Local Deals and Deal Radar take.
...
// The Rising-Demand / Price-Trend Radar. The same category sweep, read along a different
    ...
    ActionLog log, CancellationToken ct)
{
    ...
    foreach (var niche in CategorySweep.Select(seed, nicheCount))
    {
        ...
        foreach (var probe in probes)
        {
            ...
            // here as it is everywhere else — one definition of "a product", not two.
