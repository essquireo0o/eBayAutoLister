...
if ($wix) {
    ...
    & wix build "$wxsSource" -arch x64 -ext WixToolset.UI.wixext -ext WixToolset.Firewall.wixext -ext WixToolset.Util.wixext -d "SourceDir=$distDir\\" -d "RepoDir=$PSScriptRoot\\" -o "$msiPath"
